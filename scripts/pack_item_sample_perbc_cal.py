"""Pack an item-sample bundle with per-benchmark calibration + novelty labeling.

Mirrors ``pack_streamed_encoder_nn_perbc_cal.py`` but starts from the
no-calibration item-sample bundle and produces the perbc_cal variant.

Source bundle:
  - submission_item_sample_nocal.zip
Output bundle:
  - submission_item_sample_perbc_cal.zip
"""
...
OUT_ZIP = SUB_DIR / "submission_item_sample_perbc_cal.zip"
